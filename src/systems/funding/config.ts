...
function getDefaultDepositLabels(): DepositLabels {
  return {
    ...
    gasSponsored: i18n.t(i18n.l.perps.deposit.gas_sponsored),
    insufficientGas: i18n.t(i18n.l.perps.deposit.insufficient_gas),
    invalidRouteRecipientError: i18n.t(i18n.l.perps.deposit.invalid_route_recipient_error),
    missingRecipientError: i18n.t(i18n.l.perps.deposit.missing_recipient_error),
    noWalletConnected: i18n.t(i18n.l.perps.deposit.no_wallet_connected),
    unknownExecutionError: i18n.t(i18n.l.perps.deposit.unknown_execution_error),
