import { MIN_FLASHBOTS_PRIORITY_FEE } from '@/components/swaps/constants';
import { getCustomGasSettings, setCustomMaxPriorityFee } from '@/components/swaps/hooks/useCustomGas';
import { getSelectedGasSpeed } from '@/components/swaps/hooks/useSelectedGas';
import { ExtendedAnimatedAssetWithColors, ParsedSearchAsset } from '@/components/swaps/types/assets';
import { ChainId } from '@/chains/types';
import { GasSpeed } from '@/components/swaps/types/gas';
import { RecentSwap } from '@/components/swaps/types/swap';
import { getCachedGasSuggestions } from '@/components/swaps/utils/meteorology';
import { lessThan } from '@/components/swaps/utils/numbers';
import { getDefaultSlippage } from '@/components/swaps/utils/swaps';
