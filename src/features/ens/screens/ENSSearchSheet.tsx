...
import PendingRegistrations from '../components/registration/PendingRegistrations/PendingRegistrations';
import SearchInput from '../components/registration/SearchInput/SearchInput';
import SearchResultGradientIndicator from '../components/registration/SearchResult/SearchResultGradientIndicator';
import { SheetActionButton, SheetActionButtonRow } from '@/components/sheet';
import { useNavigation } from '@/navigation/Navigation';
import { Box, Heading, Inline, Inset, Separator, Stack, Text } from '@/design-system';
import { ENS_DOMAIN, REGISTRATION_MODES } from '../utils/ensHelpers';
