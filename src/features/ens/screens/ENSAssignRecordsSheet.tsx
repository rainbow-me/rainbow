...
import { getSeenOnchainDataDisclaimer, saveSeenOnchainDataDisclaimer } from '../utils/ensLocalStorage';
import { accentColorAtom, ENS_RECORDS, REGISTRATION_MODES, TextRecordField, textRecordFields } from '../utils/ensHelpers';
import { useDimensions, useKeyboardHeight, useWalletSectionsData } from '@/hooks';
...
import RegistrationAvatar from '../components/registration/RegistrationAvatar/RegistrationAvatar';
import RegistrationCover from '../components/registration/RegistrationCover/RegistrationCover';
import TextRecordsForm from '../components/registration/TextRecordsForm/TextRecordsForm';
import SelectableButton from '../components/registration/TextRecordsForm/SelectableButton';
