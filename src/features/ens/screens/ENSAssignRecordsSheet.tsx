...
import { getSeenOnchainDataDisclaimer, saveSeenOnchainDataDisclaimer } from '../utils/localStorage';
import { accentColorAtom, ENS_RECORDS, REGISTRATION_MODES, type TextRecordField, textRecordFields } from '../utils/helpers';
...
import { type ENSRoutes } from '../navigation/RegisterENSNavigator';
...
import { type EmitterSubscription, Keyboard, type LayoutChangeEvent, ScrollView } from 'react-native';
