...
import { coverMetadataAtom } from '../components/registration/RegistrationCover/RegistrationCover';
...
import { PendingTransaction } from '@/entities';
import { Records, RegistrationParameters } from '../types/ensRegistrationTypes';
import { fetchResolver } from '../utils/ensHandler';
import { saveNameFromLabelhash } from '../utils/ensLocalStorage';
import { uploadImage } from '@/handlers/pinata';
import { getProvider } from '@/handlers/web3';
import { ENS_DOMAIN, generateSalt, getRentPrice, REGISTRATION_STEPS } from '../utils/ensHelpers';
...
import { executeENSRap } from '../utils/ensActions';
