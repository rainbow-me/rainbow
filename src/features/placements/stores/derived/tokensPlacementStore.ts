...
export type TokenPlacementItem = PlacementItem<'rainbow'> & {
...
export const useTokensPlacementStore = createPlacementStore({
...
function parseTokenItems(placementItems: PlacementItem<'rainbow'>[], assetsByRef: TokenAssetsByRef): TokenPlacementItem[] {
  const items: TokenPlacementItem[] = [];

  for (const item of placementItems) {
    const asset = assetsByRef[item.ref.id];
