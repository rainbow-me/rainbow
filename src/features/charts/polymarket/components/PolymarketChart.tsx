...
//   const chartMaxY = useSharedValue(1);
//   const chartMinY = useSharedValue(0);
//   const chartStatus = useSharedValue<ChartStatus>(ChartStatus.Loading);
//   const interactionProgress = useSharedValue(0);
//   const isChartGestureActive = useSharedValue(false);

//   const initialPicture = useStableValue(() => createBlankPicture(chartWidth, providedChartHeight));
//   const chartPicture = useSharedValue(initialPicture);
//   const crosshairPicture = useSharedValue(initialPicture);
...
//     mergedConfig.chart.backgroundColor = backgroundColor;
//     return mergedConfig;
//   }, [backgroundColor, providedConfig]);
...
//   useListenerRouteGuard(useListen(usePolymarketChartStore, state => state.getData(), updateChart, { fireImmediately: true }));
