 ...
 */
export const walletsSetSelected =
  (wallet: RainbowWallet) =>
  async (dispatch: Dispatch<WalletsSetSelectedAction>) => {
...
export const updateWalletBackupStatusesBasedOnCloudUserData =
  ...
  async (
    ...
    let currentUserData:
      | { wallets: { [p: string]: RainbowWallet } }
      | undefined;
    try {
 ...
 */
export const clearAllWalletsBackupStatus =
  () =>
  async (
    dispatch: ThunkDispatch<AppState, unknown, never>,
    getState: AppGetState
 ...
 * wallets in state.
 */
export const fetchWalletENSAvatars =
  () =>
  async (
    dispatch: ThunkDispatch<AppState, unknown, never>,
    getState: AppGetState
 ...
 */
export const checkKeychainIntegrity =
  () =>
  async (
    dispatch: ThunkDispatch<AppState, unknown, never>,
    getState: AppGetState
    ...
    try {
      ...
      const hasOldSeedPhraseMigratedFlag = await hasKey(
        oldSeedPhraseMigratedKey
      );
      ...
      logger.error(
        new RainbowError("[KeychainIntegrityCheck]: error thrown'"),
        {
          message: (e as Error)?.message,
        }
      );
