...
export const pruneImageDimensionsCache = idsToPrune => dispatch => dispatch({ idsToPrune, type: PRUNE });

export const updateImageDimensionsCache = payload => dispatch => dispatch({ ...payload, type: MERGE });
