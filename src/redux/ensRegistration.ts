 ...
 */
export const ensRegistrationsLoadState =
  () =>
  async (
...
export const removeRecordByKey =
  (key: string) => async (dispatch: AppDispatch, getState: AppGetState) => {
    const {
      ensRegistration: { registrations, currentRegistrationName },
      settings: { accountAddress },
    } = getState();
...
export const clearCurrentRegistrationName =
...
export const removeRegistrationByName =
  (name: string) => async (dispatch: AppDispatch, getState: AppGetState) => {
    const {
      ensRegistration: { registrations },
      settings: { accountAddress },
    } = getState();
