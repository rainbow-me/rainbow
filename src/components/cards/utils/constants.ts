...
export const getCardColorways: (
  ...
  return {
    purple: {
      ...
      orbColorDark: isDarkMode ? globalColors.purple60 : globalColors.purple70,
    ...
    pink: {
      ...
      orbColorDark: isDarkMode ? globalColors.pink60 : globalColors.pink70,
      primaryTextColor: globalColors.white100,
    ...
    blue: {
      ...
      orbColorDark: isDarkMode ? globalColors.blue60 : globalColors.blue70,
      primaryTextColor: globalColors.white100,
    ...
    darkBlue: {
      ...
      orbColorLight: globalColors.blue20,
      orbColorDark: isDarkMode ? globalColors.blue90 : globalColors.blue100,
      primaryTextColor: globalColors.white100,
      secondaryTextColor: globalColors.blue20,
    },
    yellow: {
      ...
      orbColorDark: isDarkMode ? globalColors.yellow60 : globalColors.yellow70,
    ...
    green: {
      ...
      orbColorDark: isDarkMode ? globalColors.green60 : globalColors.green70,
      primaryTextColor: globalColors.white100,
    ...
    darkGreen: {
      ...
      orbColorLight: globalColors.green20,
      orbColorDark: isDarkMode ? globalColors.green90 : globalColors.green100,
      primaryTextColor: globalColors.white100,
      secondaryTextColor: globalColors.green20,
    },
  };
