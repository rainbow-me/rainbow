      ...
      <Message>
        <Centered>
          <Text align="center" color={colors.dark} size="bigger" weight="heavy">
            {i18n.error_boundary.error_boundary_oops()} 😅
          </Text>
        </Centered>
        <Spacer height={15} />
        <Centered>
          <Text align="center" color={colors.alpha(colors.blueGreyDark, 0.7)} lineHeight="loose" size="large" weight="bold">
            {i18n.error_boundary.something_went_wrong()}
          </Text>
        </Centered>
        <Spacer height={21} />
        <Centered>
          <Text align="center" color={colors.alpha(colors.blueGreyDark, 0.7)} lineHeight="loose" size="large" weight="bold">
            {i18n.error_boundary.wallets_are_safe()}
          </Text>
        </Centered>
        <Spacer height={33} />
        <Centered>
          <SheetActionButton
            ...
            isTransparent
            label={`🌈 ${i18n.error_boundary.restart_rainbow()}`}
