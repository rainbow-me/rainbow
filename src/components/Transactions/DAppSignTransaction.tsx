...
import { estimateGasWithPadding, getProviderForNetwork, toHex } from '@/handlers/web3';
...
export const DAppSignTransaction = <T extends RequestSource.BROWSER | RequestSource.WALLETCONNECT | RequestSource.MOBILE_WALLET_PROTOCOL>({
  transactionDetails,
