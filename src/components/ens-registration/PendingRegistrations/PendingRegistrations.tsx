              ...
              >
                <Inset horizontal="10px">
                  <Text color="action (Deprecated)" size="16px / 22px (Deprecated)" weight="heavy">
                    {i18n.profiles.pending_registrations.finish()}
                  </Text>
                </Inset>
              </Box>
    ...
    (name: string) => {
      Alert({
        buttons: [
          {
            style: 'cancel',
            text: i18n.profiles.pending_registrations.alert_cancel(),
          },
          {
            onPress: () => {
              removeRegistrationByName(name);
            },
            text: i18n.profiles.pending_registrations.alert_confirm(),
          },
        ],
        message: i18n.profiles.pending_registrations.alert_message(),
        title: i18n.profiles.pending_registrations.alert_title(),
      });
    },
    ...
    <Box paddingHorizontal="19px (Deprecated)">
      ...
      <Stack space="19px (Deprecated)">
        <Text color="secondary50 (Deprecated)" size="14px / 19px (Deprecated)" weight="bold">
          {i18n.profiles.pending_registrations.in_progress()}
        </Text>
