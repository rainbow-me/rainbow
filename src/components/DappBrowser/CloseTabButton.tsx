...
import Animated, { interpolate, useAnimatedGestureHandler, useAnimatedStyle, withTiming } from 'react-native-reanimated';
...
const CloseTabButton = (
  { onPress, tabIndex }: { onPress: () => void; tabIndex: number },
...
export default React.forwardRef(CloseTabButton);
