...
export enum CellType {
  ...
  PROFILE_HEADER_AVATAR = 'PROFILE_HEADER_AVATAR',
  PROFILE_HEADER_AVATAR_SPACE_AFTER = 'PROFILE_HEADER_AVATAR_SPACE_AFTER',
  PROFILE_HEADER_COMPACT = 'PROFILE_HEADER_COMPACT',
  PROFILE_HEADER_NAME = 'PROFILE_HEADER_NAME',
  PROFILE_HEADER_NAME_SPACE_AFTER = 'PROFILE_HEADER_NAME_SPACE_AFTER',
  PROFILE_HEADER_BALANCE = 'PROFILE_HEADER_BALANCE',
  PROFILE_HEADER_BALANCE_SPACE_AFTER = 'PROFILE_HEADER_BALANCE_SPACE_AFTER',
  PROFILE_HEADER_ACTION_BUTTONS = 'PROFILE_HEADER_ACTION_BUTTONS',
  PROFILE_HEADER_ACTION_BUTTONS_SPACE_AFTER = 'PROFILE_HEADER_ACTION_BUTTONS_SPACE_AFTER',
...
export type AssetsHeaderExtraData = {
  type: CellType.PROFILE_HEADER_COMPACT;
  value: string;
};
