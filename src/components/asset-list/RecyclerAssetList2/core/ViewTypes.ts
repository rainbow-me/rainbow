...
export type SavingsHeaderExtraData = { type: CellType.SAVINGS_HEADER; value: string };
export type SavingExtraData = { type: CellType.SAVINGS; address: string };
export type UniswapPoolExtraData = { type: CellType.UNISWAP_POOL; address: string };
export type CoinDividerExtraData = { type: CellType.COIN_DIVIDER; value: number };
export type AssetsHeaderExtraData = { type: CellType.ASSETS_HEADER; value: number };
export type PoolsHeaderExtraData = { type: CellType.POOLS_HEADER; value: number };
