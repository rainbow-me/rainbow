...
export const MaxToleranceInput = forwardRef(({ colorForAsset, chainId }: { colorForAsset: string; chainId: ChainId }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    reset: () => {
      const slippage = getDefaultSlippageFromConfig(chainId) as unknown as number;
