...
const getAssetActions = ({ chainId }: { chainId: ChainId }) =>
  ({
    [AssetActionsEnum.copyTokenID]: {
      ...
      actionTitle: i18n.expanded_state.unique_expanded.copy_token_id(),
      icon: {
        iconType: 'SYSTEM',
    ...
    [AssetActionsEnum.download]: {
      ...
      actionTitle: i18n.expanded_state.unique_expanded.save_to_photos(),
      icon: {
        iconType: 'SYSTEM',
    ...
    [AssetActionsEnum.etherscan]: {
      ...
      actionTitle: i18n.expanded_state.unique_expanded.view_on_block_explorer({
    ...
    [AssetActionsEnum.rainbowWeb]: {
      ...
      actionTitle: i18n.expanded_state.unique_expanded.view_on_web(),
      icon: {
        iconType: 'SYSTEM',
    ...
    [AssetActionsEnum.hide]: {
      ...
      actionTitle: i18n.expanded_state.unique_expanded.hide(),
      icon: {
        iconType: 'SYSTEM',
        iconValue: 'eye',
      },
    ...
    [AssetActionsEnum.refresh]: {
      ...
      actionTitle: i18n.expanded_state.unique_expanded.refresh(),
      icon: {
        iconType: 'SYSTEM',
    ...
    [AssetActionsEnum.report]: {
      ...
      actionTitle: i18n.expanded_state.unique_expanded.report(),
      icon: {
        iconType: 'SYSTEM',
...
const FamilyActions = {
  [FamilyActionsEnum.viewCollection]: {
    ...
    actionTitle: i18n.expanded_state.unique_expanded.view_collection(),
    icon: {
      iconType: 'SYSTEM',
  ...
  [FamilyActionsEnum.collectionWebsite]: {
    ...
    actionTitle: i18n.expanded_state.unique_expanded.collection_website(),
    icon: {
      iconType: 'SYSTEM',
      iconValue: 'safari.fill',
    },
  ...
  [FamilyActionsEnum.discord]: {
    ...
    actionTitle: i18n.expanded_state.unique_expanded.discord(),
    icon: {
      iconType: 'SYSTEM',
  ...
  [FamilyActionsEnum.twitter]: {
    ...
    actionTitle: i18n.expanded_state.unique_expanded.twitter(),
    icon: {
      iconType: 'SYSTEM',
...
const UniqueTokenExpandedStateHeader = ({
    ...
    return {
      menuItems: [
          ...
          ? [
              {
                ...
                actionTitle: isHiddenAsset ? i18n.expanded_state.unique_expanded.unhide() : i18n.expanded_state.unique_expanded.hide(),
                icon: {
        ...
        ...(asset.chainId === ChainId.mainnet
          ? [
              {
                menuTitle: i18n.expanded_state.unique_expanded.view_on_marketplace(),
  ...
  const onPressAndroidFamily = useCallback(() => {
    ...
    const baseActions = [
      ...(hasCollection ? [i18n.expanded_state.unique_expanded.view_collection()] : []),
      ...(hasWebsite ? [i18n.expanded_state.unique_expanded.collection_website()] : []),
      ...(hasTwitter ? [i18n.expanded_state.unique_expanded.twitter()] : []),
      ...(hasDiscord ? [i18n.expanded_state.unique_expanded.discord()] : []),
    ];
