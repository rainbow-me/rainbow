...
import type { HeadingProps } from '@/design-system/components/Heading/Heading';
...
import type { MarkdownTextProps } from '@/design-system/components/MarkdownText/MarkdownText';
