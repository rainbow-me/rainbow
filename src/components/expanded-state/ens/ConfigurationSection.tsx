        ...
        <>
          {isProfilesEnabled && !isReadOnlyWallet && !isExternal && isSetNameEnabled && (
            <InfoRow
              ...
              label={i18n.expanded_state.unique_expanded.set_primary_name()}
              onSwitchChange={() => {
          ...
          {registrant && (
            <InfoRow
              ...
              label={i18n.expanded_state.unique_expanded.owner()}
              useAccentColor
          ...
          {owner && (
            <InfoRow
              ...
              label={i18n.expanded_state.unique_expanded.manager()}
              useAccentColor
