    ...
    <>
      <Carousel height={59} marginBottom={1} marginTop={marginTop || 0}>
        ...
        {!!links?.twitter?.url && (
          <CommunityLink
            color={color}
            display={i18n.expanded_state.asset.social.twitter()}
            emojiName="x"
            transformOrigin="center"
        ...
        {!!links?.homepage?.url && (
          <CommunityLink
            color={color}
            display={i18n.expanded_state.asset.social.homepage()}
            transformOrigin="center"
        ...
        {!!links?.telegram?.url && (
          <CommunityLink
            color={color}
            display={i18n.expanded_state.asset.social.telegram()}
            emojiName="telegram"
            transformOrigin="center"
        ...
        {!!links?.reddit?.url && (
          <CommunityLink
            color={color}
            display={i18n.expanded_state.asset.social.reddit()}
            emojiName="reddit"
            transformOrigin="center"
        ...
        {!!links?.facebook?.url && (
          <CommunityLink
            color={color}
            display={i18n.expanded_state.asset.social.facebook()}
            emojiName="facebook"
            transformOrigin="center"
