...
const RainbowButtonGradient = styled(RadialGradient).attrs(({ type, width }) => ({
  radius: width,
...
const InnerButton = styled(View)(({ strokeWidth, height, width, theme: { colors } }) => ({
...
const InnerGradient = styled(RainbowButtonGradient).attrs(({ disabled, type, gradientColors }) => ({
  colors: disabled
...
const OuterGradient = styled(RainbowButtonGradient).attrs(({ disabled, type, gradientColors }) => ({
  colors: disabled
...
const RainbowButtonBackground = ({ disabled, height, strokeWidth, type, width }) => {
