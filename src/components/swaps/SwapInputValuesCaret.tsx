...
import { SLIDER_COLLAPSED_HEIGHT, SLIDER_HEIGHT, caretConfig } from '@/components/swaps/constants';
import { equalWorklet } from '@/safe-math/SafeMath';
import { NavigationSteps } from '@/components/swaps/hooks/useSwapNavigation';
import { useSwapContext } from '@/components/swaps/providers/SwapProvider';
import { inputKeys } from '@/components/swaps/types/swap';
