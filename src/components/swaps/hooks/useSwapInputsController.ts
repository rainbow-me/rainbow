...
import { SCRUBBER_WIDTH, SLIDER_WIDTH, snappySpringConfig } from '@/components/swaps/constants';
import { ExtendedAnimatedAssetWithColors } from '@/components/swaps/types/assets';
import { ChainId } from '@/chains/types';
import { RequestNewQuoteParams, inputKeys, inputMethods, inputValuesType } from '@/components/swaps/types/swap';
import { valueBasedDecimalFormatter } from '@/components/swaps/utils/decimalFormatter';
import { getInputValuesForSliderPositionWorklet, updateInputValuesAfterFlip } from '@/components/swaps/utils/flipAssets';
import {
  convertAmountToNativeDisplayWorklet,
  convertRawAmountToDecimalFormat,
  handleSignificantDecimalsWorklet,
} from '@/components/swaps/utils/numbers';
import {
  addCommasToNumber,
  ...
  trimTrailingZeros,
} from '@/components/swaps/utils/swaps';
