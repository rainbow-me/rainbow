import { LIGHT_SEPARATOR_COLOR, SEPARATOR_COLOR, THICK_BORDER_WIDTH } from '@/components/swaps/constants';
...
import { useBottomPanelGestureHandler } from '@/components/swaps/hooks/useBottomPanelGestureHandler';
