      ...
      <Inset horizontal={'24px'}>
        <Stack alignHorizontal="left" space="8px">
          <Masthead>
            ...
            />
            <Stack space="12px">
              <Title>{i18n.back_up.cloud.password.choose_a_password()}</Title>
              <DescriptionText>
                {i18n.back_up.cloud.password.a_password_youll_remember_part_one()}
                &nbsp;
                <ImportantText>{i18n.back_up.cloud.password.not()}</ImportantText>
                &nbsp;
                {i18n.back_up.cloud.password.a_password_youll_remember_part_two()}
              </DescriptionText>
            </Stack>
          </Masthead>
          <Box gap={12}>
            <PasswordField
              ...
              password={password}
              placeholder={i18n.back_up.cloud.password.backup_password()}
              ref={passwordRef}
              returnKeyType="next"
            ...
            {isCloudBackupPasswordValid(password) && (
              <PasswordField
                ...
                placeholder={i18n.back_up.cloud.password.confirm_placeholder()}
        ...
        <Box paddingTop="16px" justifyContent="flex-end">
          {validPassword && (
            <RainbowButton
              ...
              label={`􀎽 ${i18n.back_up.cloud.back_up_to_platform({
          ...
          {!validPassword && (
            ...
            >
              <ButtonText>
                {`􀎽 ${i18n.back_up.cloud.back_up_to_platform({
                  cloudPlatformName: cloudPlatform,
                })}`}
              </ButtonText>
            </Box>
