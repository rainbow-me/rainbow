...
var ethPermitEthers = require('eth-permit-ethers');
...
function signPermit(wallet, tokenAddress, holder, spender, amount, deadline) {
  if (tokenAddress.toLowerCase() === DAI_ADDRESS) {
    return ethPermitEthers.signDaiPermit(wallet, tokenAddress, holder, spender, deadline);
  } else {
    return ethPermitEthers.signERC2612Permit(wallet, tokenAddress, holder, spender, amount, deadline);
  }
}
