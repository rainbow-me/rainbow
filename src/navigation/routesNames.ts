...
const Routes = {
  ...
  POLYMARKET_DEPOSIT_SCREEN: 'PolymarketDepositScreen',
  POLYMARKET_WITHDRAWAL_SCREEN: 'PolymarketWithdrawalScreen',
  ...
  POLYMARKET_CONVERT_COLLATERAL_SHEET: 'PolymarketConvertCollateralSheet',
...
export const NATIVE_ROUTES = new Set<Route>([
  ...
  Routes.POLYMARKET_DEPOSIT_SCREEN,
  Routes.POLYMARKET_WITHDRAWAL_SCREEN,
