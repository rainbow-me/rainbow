...
// TODO
export const fromWei = (number, decimals = 18) => new BigNumber(number.toString(10), 10)
 ...
 * @return {String}
 */
export const convertAmountToRawAmount = (value, decimals) => BigNumber(value).times(BigNumber(10).pow(decimals)).toString();
