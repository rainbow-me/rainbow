    ...
    menuItems: [
      isENSProfile &&
        ...
        !isZeroETH && {
          ...
          actionTitle: i18n.profiles.profile_avatar.edit_profile(),
          ...(ios && { icon: { iconType: 'SYSTEM', iconValue: 'pencil.circle' } }),
        },
      isENSProfile && {
        actionKey: 'viewProfile',
        actionTitle: i18n.profiles.profile_avatar.view_profile(),
      ...
      !isENSProfile &&
        ...
        !isZeroETH && {
          ...
          actionTitle: i18n.profiles.profile_avatar.create_profile(),
          ...(ios && { icon: { iconType: 'SYSTEM', iconValue: 'person.crop.circle' } }),
        },
      {
        actionKey: 'chooseFromLibrary',
        actionTitle: i18n.profiles.profile_avatar.choose_from_library(),
      ...
      !accountImage
        ? ios
          ? {
              actionKey: 'pickEmoji',
              actionTitle: i18n.profiles.profile_avatar.pick_emoji(),
              icon: {
                iconType: 'SYSTEM',
          ...
          : {
              ...
              actionTitle: i18n.profiles.profile_avatar.shuffle_emoji(),
            }
        : {
            actionKey: 'removePhoto',
            actionTitle: i18n.profiles.profile_avatar.remove_photo(),
          },
    ].filter(Boolean),
  };
