...
This directory is the live home of the library. It began as the standalone [react-native-animated-charts](https://github.com/rainbow-me/react-native-animated-charts) package, was vendored into this repo in 2020, and has been developed here exclusively since late 2021 (TypeScript migration, modern Reanimated, candlestick support). The standalone GitHub repository is an archived snapshot and no longer reflects this code.

Import from the entry point: `@/react-native-animated-charts/src`. Real-life consumers include `src/components/value-chart/LineChart.tsx`.
...
import { ChartDot, ChartPath, ChartPathProvider, monotoneCubicInterpolation } from '@/react-native-animated-charts/src';
