...
import Animated, { useAnimatedStyle, withSpring, WithSpringConfig } from 'react-native-reanimated';
...
const ChartDot = React.memo(({ style, size = 10, springConfig, ...props }: ChartDotProps) => {
  ...
  const animatedStyle = useAnimatedStyle(() => {
    ...
    const animation = withSpring(isActive.value ? 1 : 0, springConfig || springDefaultConfig);
