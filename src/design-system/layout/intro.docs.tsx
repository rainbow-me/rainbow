  ...
  description: (
    <>
      <Docs.Text>
        ...
        surrounding space. If components have margins built into them, it
        becomes difficult to compose them into a layout because space will be
        unbalanced by default.
      </Docs.Text>
      <Docs.Text>
        To better understand layout, let&apos;s step through the available
        layout components and show how they can be composed together.
      </Docs.Text>
      <Docs.Blockquote>
        <Docs.Text>
          ...
          the scale, it can be provided in the following format:{' '}
          <Docs.Code>
            space={'{{'} custom: 17 {'}}'}
          </Docs.Code>
          .
