  ...
  description: (
    <>
      <Docs.Text>
        ...
        ends up creating a lot of extra work during development to fix
        unbalanced spacing.
      </Docs.Text>
      <Docs.Text>
        To correct for this, we use a library called{' '}
        <Docs.TextLink href="https://seek-oss.github.io/capsize">
          Capsize
        </Docs.TextLink>{' '}
      ...
      <Docs.Blockquote>
        <Docs.Text>
          Using Capsize in React Native gets us really close, but unfortunately
          ...
          decimal between 1 and -1. If you have any insight into why we need to
          do this, please let us know 🙏
        </Docs.Text>
      </Docs.Blockquote>
      <Docs.Text>
        Text is handled by the <Docs.Code>Text</Docs.Code> and{' '}
        <Docs.Code>Heading</Docs.Code> components. Both of these components
        optionally support <Docs.Code>size</Docs.Code>,{' '}
        <Docs.Code>weight</Docs.Code> and <Docs.Code>align</Docs.Code> props,
        while <Docs.Code>Text</Docs.Code> also has props for{' '}
