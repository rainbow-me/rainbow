...
export const DAI_OPTIMISM_ADDRESS = '0xda10009cbd5d07dd0cecc66161fc93d7c9000da1';
export const USDC_OPTIMISM_ADDRESS = '0x7f5c764cbc14f9669b88837ca1490cca17c31607';
export const WBTC_OPTIMISM_ADDRESS = '0x68f180fcce6836688e9084f035309e29bf0a2095';
...
export const WBTC_ARBITRUM_ADDRESS = '0x2f2a2543b76a4166549f7aab2e75bef0aefc5b0f';
export const SOCKS_ARBITRUM_ADDRESS = '0xd803b242d32d71618d0646531c0cc4a5d26d1598';
...
export const LEGACY_CHAINS_FOR_HW = [ChainId.optimism, ChainId.arbitrum, ChainId.zora, ChainId.base];

export const SUPPORTED_MAINNET_CHAINS: Chain[] = [mainnet, polygon, optimism, arbitrum, base, zora, bsc].map(chain => ({
  ...chain,
...
export const SUPPORTED_TESTNET_CHAIN_IDS: number[] = SUPPORTED_TESTNET_CHAINS.map(tn => tn.id);
