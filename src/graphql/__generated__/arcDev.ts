...
export type CollectionsForAddressResponse = {
  __typename?: 'CollectionsForAddressResponse';
  data: Array<Maybe<NftCollectionData>>;
  nextPageKey?: Maybe<Scalars['String']>;
  totalCollections: Scalars['Int'];
};
...
export type FeaturedResult = {
  __typename?: 'FeaturedResult';
  advertiserId: Scalars['String'];
  category?: Maybe<Scalars['String']>;
  context?: Maybe<FeaturedResultContext>;
  ctas?: Maybe<Array<FeaturedResultCallToAction>>;
  description: Scalars['String'];
  id: Scalars['String'];
  imageAltText: Scalars['String'];
  imageUrl: Scalars['String'];
  imageVariants?: Maybe<ImageVariants>;
  impressionId: Scalars['String'];
  placementSlug: Scalars['String'];
  title: Scalars['String'];
  type: FeaturedResultType;
};

export type FeaturedResultCallToAction = {
  __typename?: 'FeaturedResultCallToAction';
  href: Scalars['String'];
  title: Scalars['String'];
};

export type FeaturedResultContext = {
  __typename?: 'FeaturedResultContext';
  text: Scalars['String'];
};

export type FeaturedResultsResponse = {
  __typename?: 'FeaturedResultsResponse';
  items?: Maybe<Array<FeaturedResult>>;
};

export enum FeaturedResultType {
  Card = 'CARD',
  Discord = 'DISCORD',
  Iframe = 'IFRAME'
}
...
export type ImageVariants = {
  ...
  orig?: Maybe<ImageVariant>;
  x1?: Maybe<ImageVariant>;
  x2?: Maybe<ImageVariant>;
  x3?: Maybe<ImageVariant>;
};

export type Market = {
  __typename?: 'Market';
  ath?: Maybe<PricePoint>;
  atl?: Maybe<PricePoint>;
  circulating_supply?: Maybe<Scalars['Float']>;
  currency_used?: Maybe<Scalars['String']>;
  fdv?: Maybe<Scalars['Float']>;
  market_cap?: Maybe<MarketCap>;
...
export type MarketCap = {
  ...
  change_24h?: Maybe<Scalars['Float']>;
...
export type Mutation = {
  __typename?: 'Mutation';
  trackFeaturedResult?: Maybe<TrackFeaturedResultResponse>;
};


export type MutationTrackFeaturedResultArgs = {
  featuredResultCreativeId: Scalars['String'];
  impressionId: Scalars['String'];
...
export enum NftCollectionSortCriterion {
  Abc = 'ABC',
...
export enum NftTokenType {
  Erc1155 = 'ERC1155',
  Erc721 = 'ERC721',
  NoSupportedNftStandard = 'NO_SUPPORTED_NFT_STANDARD',
...
export type PoolData = {
  __typename?: 'PoolData';
  currency_used: Scalars['String'];
  h1_price_change?: Maybe<Scalars['Float']>;
  h1_volume?: Maybe<Scalars['Float']>;
  h24_price_change?: Maybe<Scalars['Float']>;
  h24_volume?: Maybe<Scalars['Float']>;
  h6_price_change?: Maybe<Scalars['Float']>;
  h6_volume?: Maybe<Scalars['Float']>;
  m5_price_change?: Maybe<Scalars['Float']>;
  m5_volume?: Maybe<Scalars['Float']>;
...
export type PricePoint = {
  ...
  change_percentage?: Maybe<Scalars['Float']>;
  date?: Maybe<Scalars['DateTime']>;
  value?: Maybe<Scalars['Float']>;
};
...
export type Query = {
  ...
  getNftsMetadata: Array<UniqueAsset>;
  ...
  nftCollections: CollectionsForAddressResponse;
  nftOffers?: Maybe<Array<NftOffer>>;
  nfts?: Maybe<Array<SimpleHashNft>>;
  nftsByCollection: Array<UniqueAsset>;
  nftsByPage?: Maybe<NfTs>;
  nftsV2?: Maybe<Array<SimpleHashNft>>;
  person?: Maybe<Person>;
  personCollection?: Maybe<PersonCollection>;
...
export type QueryFeaturedResultsArgs = {
...
export type QueryGetNftsMetadataArgs = {
  tokens: Scalars['JSON'];
  walletAddress: Scalars['String'];
};
...
export type QueryNftsByCollectionArgs = {
  collectionId: Scalars['String'];
  walletAddress: Scalars['String'];
};


export type QueryNftsByPageArgs = {
  cursor?: InputMaybe<Scalars['String']>;
  limit?: InputMaybe<Scalars['Int']>;
  networks?: InputMaybe<Array<Scalars['String']>>;
  walletAddress: Scalars['String'];
};


export type QueryNftsV2Args = {
  sortBy?: InputMaybe<NftCollectionSortCriterion>;
...
export type RainbowCollectionWithDetails = {
  __typename?: 'RainbowCollectionWithDetails';
  collection_details: SimpleHashCollectionDetails;
  collection_id: Scalars['String'];
  distinct_nfts_owned: Scalars['String'];
  last_acquired_date?: Maybe<Scalars['String']>;
  nft_ids: Array<Scalars['String']>;
  total_copies_owned: Scalars['String'];
};
...
export type SimpleHashCollectionDetails = {
  __typename?: 'SimpleHashCollectionDetails';
  banner_image_url?: Maybe<Scalars['String']>;
  category?: Maybe<Scalars['String']>;
  chains: Array<Scalars['String']>;
  collection_id: Scalars['String'];
  collection_royalties: Array<SimpleHashRoyalty>;
  description?: Maybe<Scalars['String']>;
  discord_url?: Maybe<Scalars['String']>;
  distinct_nft_count: Scalars['Int'];
  distinct_owner_count: Scalars['Int'];
  external_url?: Maybe<Scalars['String']>;
  floor_prices: Array<SimpleHashCollectionFloorPrice>;
  image_url?: Maybe<Scalars['String']>;
  instagram_username?: Maybe<Scalars['String']>;
  is_nsfw: Scalars['Boolean'];
  marketplace_pages: Array<SimpleHashCollectionMarketplacePage>;
  medium_username?: Maybe<Scalars['String']>;
  metaplex_first_verified_creator?: Maybe<Scalars['String']>;
  metaplex_mint?: Maybe<Scalars['String']>;
  name: Scalars['String'];
  spam_score: Scalars['Float'];
  telegram_url?: Maybe<Scalars['String']>;
  top_contracts: Array<Scalars['String']>;
...
export type SimpleHashNft = {
  ...
  queried_wallet_balances?: Maybe<Array<Maybe<SimpleHashQueriedWalletBalance>>>;
...
export type SimpleHashQueriedWalletBalance = {
  __typename?: 'SimpleHashQueriedWalletBalance';
  address?: Maybe<Scalars['String']>;
  first_acquired_date?: Maybe<Scalars['String']>;
  last_acquired_date?: Maybe<Scalars['String']>;
...
export type SwapStats = {
  __typename?: 'SwapStats';
  farcaster_users?: Maybe<Array<FarcasterUser>>;
  total_transactions?: Maybe<Scalars['Int']>;
  total_volume?: Maybe<Scalars['Float']>;
  unique_users?: Maybe<Scalars['Int']>;
};
...
export type TrackFeaturedResultResponse = {
  __typename?: 'TrackFeaturedResultResponse';
  message: Scalars['String'];
};

export enum TrackFeaturedResultType {
  Click = 'CLICK',
...
export type TrendingData = {
  ...
  rank: Scalars['Int'];
  swap_data: SwapData;
  trending_since: Scalars['DateTime'];
};
...
export type TrendingToken = {
  ...
  decimals: Scalars['Int'];
  highLiquidity: Scalars['Boolean'];
  icon_url: Scalars['String'];
  isRainbowCurated: Scalars['Boolean'];
...
export type TrendingTokens = {
  __typename?: 'TrendingTokens';
  data: Array<TrendingToken>;
};

export type UniqueAsset = {
  __typename?: 'UniqueAsset';
...
export type UniqueAssetImages = {
  __typename?: 'UniqueAssetImages';
  animatedMimeType?: Maybe<Scalars['String']>;
  animatedUrl?: Maybe<Scalars['String']>;
  highResUrl?: Maybe<Scalars['String']>;
  lowResUrl?: Maybe<Scalars['String']>;
  mimeType?: Maybe<Scalars['String']>;
};

export type UniqueAssetTrait = {
  __typename?: 'UniqueAssetTrait';
...
export type AssetAmountFragment = { __typename?: 'AssetAmount', raw: string, decimal: number, usd: number };
...
export type GetNftCollectionsQuery = { __typename?: 'Query', nftCollections: { __typename?: 'CollectionsForAddressResponse', totalCollections: number, nextPageKey?: string | null, data: Array<{ __typename?: 'NftCollectionData', id: string, name: string, imageUrl: string, totalCount: string } | null> } };
...
export type GetNftsByCollectionQuery = { __typename?: 'Query', nftsByCollection: Array<{ __typename?: 'UniqueAsset', name: string, acquiredAt?: string | null, uniqueId: string, description?: string | null, standard: NftTokenType, isSendable: boolean, backgroundColor?: string | null, type: string, collectionName?: string | null, collectionUrl?: string | null, collectionDescription?: string | null, collectionImageUrl?: string | null, discordUrl?: string | null, twitterUrl?: string | null, websiteUrl?: string | null, marketplaceName?: string | null, marketplaceUrl?: string | null, floorPrice?: number | null, images: { __typename?: 'UniqueAssetImages', highResUrl?: string | null, lowResUrl?: string | null, mimeType?: string | null, animatedUrl?: string | null, animatedMimeType?: string | null }, traits: Array<{ __typename?: 'UniqueAssetTrait', trait_type: string, value: string }> }> };

export type GetNftsMetadataQueryVariables = Exact<{
  walletAddress: Scalars['String'];
  tokens: Scalars['JSON'];
}>;


export type GetNftsMetadataQuery = { __typename?: 'Query', getNftsMetadata: Array<{ __typename?: 'UniqueAsset', name: string, acquiredAt?: string | null, uniqueId: string, description?: string | null, standard: NftTokenType, isSendable: boolean, backgroundColor?: string | null, type: string, collectionName?: string | null, collectionUrl?: string | null, collectionDescription?: string | null, collectionImageUrl?: string | null, discordUrl?: string | null, twitterUrl?: string | null, websiteUrl?: string | null, marketplaceName?: string | null, marketplaceUrl?: string | null, floorPrice?: number | null, images: { __typename?: 'UniqueAssetImages', highResUrl?: string | null, lowResUrl?: string | null, mimeType?: string | null, animatedUrl?: string | null, animatedMimeType?: string | null }, traits: Array<{ __typename?: 'UniqueAssetTrait', trait_type: string, value: string }> }> };

export type GetFeaturedResultsQueryVariables = Exact<{
  placementId: Scalars['String'];
  walletAddress: Scalars['String'];
  country?: InputMaybe<Scalars['String']>;
  limit?: InputMaybe<Scalars['Int']>;
...
export type GetFeaturedResultsQuery = { __typename?: 'Query', featuredResults: { __typename?: 'FeaturedResultsResponse', items?: Array<{ __typename?: 'FeaturedResult', id: string, type: FeaturedResultType, impressionId: string, advertiserId: string, placementSlug: string, title: string, description: string, imageUrl: string, category?: string | null, imageAltText: string, context?: { __typename?: 'FeaturedResultContext', text: string } | null, ctas?: Array<{ __typename?: 'FeaturedResultCallToAction', title: string, href: string }> | null }> | null } };

export type TrackFeaturedResultMutationVariables = Exact<{
  type: TrackFeaturedResultType;
  placementId: Scalars['String'];
  impressionId: Scalars['String'];
  featuredResultCreativeId: Scalars['String'];
...
export type TrackFeaturedResultMutation = { __typename?: 'Mutation', trackFeaturedResult?: { __typename?: 'TrackFeaturedResultResponse', message: string } | null };

export type TrendingTokensQueryVariables = Exact<{
  chainId?: InputMaybe<Scalars['Int']>;
  currency?: InputMaybe<Scalars['String']>;
  timeframe?: InputMaybe<Timeframe>;
  category?: InputMaybe<TrendingCategory>;
  sortBy?: InputMaybe<TrendingSort>;
  sortDirection?: InputMaybe<SortDirection>;
  walletAddress?: InputMaybe<Scalars['String']>;
  limit?: InputMaybe<Scalars['Int']>;
}>;
...
export type TrendingTokensQuery = { __typename?: 'Query', trendingTokens: { __typename?: 'TrendingTokens', data: Array<{ __typename?: 'TrendingToken', icon_url: string, name: string, symbol: string, decimals: number, highLiquidity: boolean, isRainbowCurated: boolean, isVerified: boolean, uniqueId: string, address: string, creationDate?: any | null, chainId: number, transferable: boolean, colors: { __typename?: 'Colors', primary: string, fallback?: string | null, shadow?: string | null }, networks: { __typename?: 'Networks', _?: { __typename?: 'NetworkInfo', address: string, decimals: number } | null }, market: { __typename?: 'Market', currency_used?: string | null, fdv?: number | null, volume_24h?: number | null, circulating_supply?: number | null, total_supply?: number | null, max_supply?: number | null, updated_at?: any | null, market_cap?: { __typename?: 'MarketCap', value?: number | null, change_24h?: number | null } | null, price?: { __typename?: 'Price', value?: number | null, change_24h?: number | null } | null, ath?: { __typename?: 'PricePoint', value?: number | null, change_percentage?: number | null, date?: any | null } | null, atl?: { __typename?: 'PricePoint', value?: number | null, change_percentage?: number | null, date?: any | null } | null }, trending: { __typename?: 'TrendingData', rank: number, trending_since: any, pool_data: { __typename?: 'PoolData', currency_used: string, reserve?: number | null, m5_volume?: number | null, h1_volume?: number | null, h6_volume?: number | null, h24_volume?: number | null, m5_price_change?: number | null, h1_price_change?: number | null, h6_price_change?: number | null, h24_price_change?: number | null }, swap_data: { __typename?: 'SwapData', currency_used: string, bought_stats: { __typename?: 'SwapStats', unique_users?: number | null, total_transactions?: number | null, total_volume?: number | null, farcaster_users?: Array<{ __typename?: 'FarcasterUser', fid: number, username?: string | null, pfp_url?: string | null, follower_count: number, following_count: number, power_badge: boolean }> | null }, sold_stats: { __typename?: 'SwapStats', unique_users?: number | null, total_transactions?: number | null, total_volume?: number | null, farcaster_users?: Array<{ __typename?: 'FarcasterUser', fid: number, username?: string | null, pfp_url?: string | null, follower_count: number, following_count: number, power_badge: boolean }> | null } } }, bridging: { __typename?: 'Bridging', bridgeable: boolean, networks?: { __typename?: 'Networks', _?: { __typename?: 'NetworkInfo', address: string, decimals: number } | null } | null } }> } };
...
export const AssetFragmentDoc = gql`
  ...
  name
    ...
    `;
export const AssetAmountFragmentDoc = gql`
...
export const GetNftCollectionsDocument = gql`
  ...
  nftCollections(walletAddress: $walletAddress, limit: $limit, pageKey: $pageKey) {
    ...
    `;
export const GetNftsByCollectionDocument = gql`
  ...
  nftsByCollection(walletAddress: $walletAddress, collectionId: $collectionId) {
    ...
    `;
export const GetNftsMetadataDocument = gql`
  ...
  getNftsMetadata(walletAddress: $walletAddress, tokens: $tokens) {
    ...
    `;
export const GetFeaturedResultsDocument = gql`
  ...
  featuredResults(placementId: $placementId, walletAddress: $walletAddress, country: $country, limit: $limit) {
    ...
    `;
export const TrackFeaturedResultDocument = gql`
    mutation trackFeaturedResult($type: TrackFeaturedResultType!, $placementId: String!, $impressionId: String!, $featuredResultCreativeId: String!) {
  trackFeaturedResult(type: $type, placementId: $placementId, impressionId: $impressionId, featuredResultCreativeId: $featuredResultCreativeId) {
    message
  }
}
    `;
export const TrendingTokensDocument = gql`
    query trendingTokens($chainId: Int, $currency: String, $timeframe: Timeframe, $category: TrendingCategory, $sortBy: TrendingSort, $sortDirection: SortDirection, $walletAddress: String, $limit: Int) {
  trendingTokens(chainId: $chainId, currency: $currency, timeframe: $timeframe, category: $category, sortBy: $sortBy, sortDirection: $sortDirection, walletAddress: $walletAddress, limit: $limit) {
    data {
      colors {
        primary
        fallback
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    ...
    getNftCollections(variables: GetNftCollectionsQueryVariables, options?: C): Promise<GetNftCollectionsQuery> {
      return requester<GetNftCollectionsQuery, GetNftCollectionsQueryVariables>(GetNftCollectionsDocument, variables, options) as Promise<GetNftCollectionsQuery>;
    },
    getNftsByCollection(variables: GetNftsByCollectionQueryVariables, options?: C): Promise<GetNftsByCollectionQuery> {
      return requester<GetNftsByCollectionQuery, GetNftsByCollectionQueryVariables>(GetNftsByCollectionDocument, variables, options) as Promise<GetNftsByCollectionQuery>;
    },
    getNftsMetadata(variables: GetNftsMetadataQueryVariables, options?: C): Promise<GetNftsMetadataQuery> {
      return requester<GetNftsMetadataQuery, GetNftsMetadataQueryVariables>(GetNftsMetadataDocument, variables, options) as Promise<GetNftsMetadataQuery>;
    },
    getFeaturedResults(variables: GetFeaturedResultsQueryVariables, options?: C): Promise<GetFeaturedResultsQuery> {
      return requester<GetFeaturedResultsQuery, GetFeaturedResultsQueryVariables>(GetFeaturedResultsDocument, variables, options) as Promise<GetFeaturedResultsQuery>;
    },
    trackFeaturedResult(variables: TrackFeaturedResultMutationVariables, options?: C): Promise<TrackFeaturedResultMutation> {
      return requester<TrackFeaturedResultMutation, TrackFeaturedResultMutationVariables>(TrackFeaturedResultDocument, variables, options) as Promise<TrackFeaturedResultMutation>;
    },
    trendingTokens(variables?: TrendingTokensQueryVariables, options?: C): Promise<TrendingTokensQuery> {
      return requester<TrendingTokensQuery, TrendingTokensQueryVariables>(TrendingTokensDocument, variables, options) as Promise<TrendingTokensQuery>;
    }
  };
}
