...
const VERIFIED_RAINBOW_TOKEN_LIST = filter(
  TOKEN_LIST_WITH_ETH,
  'extensions.isVerified'
);

const VERIFIED_UNISWAP_TOKENS = keyBy(VERIFIED_RAINBOW_TOKEN_LIST, 'address');
