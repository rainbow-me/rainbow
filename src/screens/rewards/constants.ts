...
export const DARK_RANK_1_GRADIENT_COLORS = ['#FFE456', '#CF9500'] as const;
export const DARK_RANK_2_GRADIENT_COLORS = ['#FBFCFE', '#B3BCC7'] as const;
export const DARK_RANK_3_GRADIENT_COLORS = ['#DE8F38', '#AE5F25'] as const;

export const LIGHT_RANK_1_GRADIENT_COLORS = ['#E2B730', '#CF9500'] as const;
