...
import BackupSheetKeyboardLayout from '../components/backup/BackupSheetKeyboardLayout';
...
export default function RestoreFromCloudSheet({
  userData,
  backupSelected,
  fromSettings,
}) {
  ...
  return (
    <Box width="full" height={{ custom: 200 }}></Box>
    ...
    //           )}
    //           <Title>
    //             {lang.t('back_up.restore_cloud.enter_backup_password')}
    //           </Title>
    //           <DescriptionText>
    //             {lang.t(
    //               'back_up.restore_cloud.enter_backup_password_description'
    //             )}
    //           </DescriptionText>
    //         </Masthead>
