      ...
      buttons: [
        {
          ...
          text: i18n.check_identifier.error_alert.contact_support(),
        },
        {
          style: 'cancel',
          text: i18n.check_identifier.error_alert.cancel(),
        },
      ],
      message: i18n.check_identifier.error_alert.message(),
      title: i18n.check_identifier.error_alert.title(),
    });
