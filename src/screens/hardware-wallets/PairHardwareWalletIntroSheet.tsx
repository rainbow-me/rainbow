          ...
          <Stack space="10px">
            ...
            <ButtonPressAnimation onPress={() => openInBrowser('https://www.ledger.com')} scaleTo={0.9}>
              <Text align="center" color="blue" weight="semibold" size="15pt / 135%">
                {TRANSLATIONS.learn_more_about_ledger()}
              </Text>
            </ButtonPressAnimation>
          </Stack>
        </Stack>
      </Inset>
      <ActionButton onPress={() => navigate(Routes.PAIR_HARDWARE_WALLET_SEARCH_SHEET)} label={TRANSLATIONS.pair_a_new_ledger()} />
    </Layout>
  );
};
