...
const DevSection = () => {
  ...
  const checkAlert = useCallback(async () => {
    try {
      ...
      await request.json();
      Alert.alert(i18n.developer_settings.status(), i18n.developer_settings.not_applied());
    } catch (e) {
      Alert.alert(i18n.developer_settings.status(), i18n.developer_settings.applied());
    }
  }, []);
  ...
  const removeBackups = async () => {
    ...
    Alert.alert(i18n.developer_settings.backups_deleted_successfully());
    Restart();
  };
    ...
    <MenuContainer testID="developer-settings-sheet">
      <Menu header={IS_DEV || isTestFlight ? 'Normie Settings' : ''}>
        {/* <MenuItem
          ...
          titleComponent={
            <MenuItem.Title
              text={i18n.developer_settings.enable_testnets()}
            />
          }
        />
        ...
        <MenuItem
          ...
          size={52}
          titleComponent={<MenuItem.Title text={i18n.developer_settings.clear_local_storage()} />}
        ...
        <MenuItem
          ...
          titleComponent={<MenuItem.Title text={i18n.developer_settings.clear_pending_txs()} />}
        />
        <MenuItem
          leftComponent={<MenuItem.TextIcon icon="🚨" isEmoji />}
          ...
          titleComponent={<MenuItem.Title text={i18n.developer_settings.keychain.menu_title()} />}
        />
      </Menu>
      {(IS_DEV || isTestFlight) && (
        <>
          <Menu header="Rainbow Developer Settings">
            <MenuItem
              ...
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.restart_app()} />}
            />
            ...
            <MenuItem
              ...
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.analyze_react_query()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="🔦" isEmoji />}
              onPress={() => analyzeUserAssets()}
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.analyze_user_assets_query()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="🗑️" isEmoji />}
              onPress={() => clearReactQueryCache()}
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.clear_react_query_cache()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="💥" isEmoji />}
              onPress={clearAsyncStorage}
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.clear_async_storage()} />}
            ...
            <MenuItem
              ...
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.clear_mmkv_storage()} />}
            ...
            <MenuItem
              ...
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.clear_image_metadata_cache()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="📷️" isEmoji />}
              onPress={clearImageCache}
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.clear_image_cache()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="💥" isEmoji />}
              ...
              titleComponent={<MenuItem.Title text={i18n.developer_settings.crash_app_render_error()} />}
            />
            {errorObj}
            {/* TEMP: Removal for public TF}
            {/* <MenuItem
              ...
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.remove_all_backups()} />}
            /> */}
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="🤷" isEmoji />}
              onPress={() => AsyncStorage.removeItem('experimentalConfig')}
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.reset_experimental_config()} />}
            />
                ...
                <MenuItem.Title
                  text={
                    useConnectedToAnvilStore.getState().connectedToAnvil
                      ? i18n.developer_settings.disconnect_to_anvil()
                      : i18n.developer_settings.connect_to_anvil()
                  }
                />
              }
            />
            <MenuItem
              ...
              titleComponent={<MenuItem.Title text={i18n.developer_settings.alert()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="🗺️" isEmoji />}
              onPress={onPressNavigationEntryPoint}
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.navigation_entry_point()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="🤖" isEmoji />}
              onPress={async () => {
              ...
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.copy_signing_wallet_address()} />}
            />
            <MenuItem
              leftComponent={<MenuItem.TextIcon icon="🌎" isEmoji />}
              onPress={async () => {
              ...
              size={52}
              titleComponent={<MenuItem.Title text={i18n.developer_settings.copy_fcm_token()} />}
            />
            {getExperimentalFlag(LOG_PUSH) && (
              <MenuItem
                ...
                size={52}
                titleComponent={<MenuItem.Title text={i18n.developer_settings.copy_log_lines()} />}
              />
            )}
          </Menu>
...
function confirmKeychainAlert(): Promise<boolean> {
  return new Promise<boolean>(resolve => {
    Alert.alert(i18n.developer_settings.keychain.alert_title(), i18n.developer_settings.keychain.alert_body(), [
      {
        onPress: () => {
          resolve(true);
        },
        text: i18n.developer_settings.keychain.delete_wallets(),
      },
      {
        onPress: () => {
          resolve(false);
