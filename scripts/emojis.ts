...
// and writes it to `src/framework/core/emoji/references/emojisByCategory.json`.
//
// Run with:
...
const OUTPUT_PATH = path.resolve(__dirname, '../src/framework/core/emoji/references/emojisByCategory.json');
