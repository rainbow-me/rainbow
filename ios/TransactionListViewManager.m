...
RCT_EXPORT_VIEW_PROPERTY(avatarOptions, NSArray)
RCT_EXPORT_VIEW_PROPERTY(onAvatarPickEmoji, RCTBubblingEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onAvatarChooseImage, RCTBubblingEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onAvatarRemovePhoto, RCTBubblingEventBlock)
